...
# 4.2.1_plot_threshold_sweep.py to render the heatmaps.
#
# Usage:
#   bash benchmarks/Paper_Evaluations/4/threshold_sweep/4.2.1_run_all_threshold_sweeps.sh
#
...
for w in $WORKLOADS; do
    child="$SCRIPT_DIR/4.2.1_eval_${w}_threshold_sweep.sh"
    if [ ! -f "$child" ]; then
        echo ""
