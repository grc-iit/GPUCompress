#!/bin/bash
# 4n4g: Lossy (error_bound=0.01), ratio policy (30min)
#SBATCH --account=bekn-delta-gpu
#SBATCH --partition=gpuA100x4
#SBATCH --job-name=vpic-4n4g-ly-rat-30m
#SBATCH --output=vpic-4n4g-ly-rat-30m-%j.out
#SBATCH --error=vpic-4n4g-ly-rat-30m-%j.err
#SBATCH --nodes=4
...
VERIFY=1 POLICIES=ratio LOSSY=0.01 \
