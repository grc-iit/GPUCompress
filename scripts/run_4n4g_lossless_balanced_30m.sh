#!/bin/bash
# 4n4g: Lossless, balanced policy (30min)
#SBATCH --account=bekn-delta-gpu
#SBATCH --partition=gpuA100x4
#SBATCH --job-name=vpic-4n4g-ll-bal-30m
#SBATCH --output=vpic-4n4g-ll-bal-30m-%j.out
#SBATCH --error=vpic-4n4g-ll-bal-30m-%j.err
#SBATCH --nodes=4
...
VERIFY=1 POLICIES=balanced LOSSY=0 \
