...
(Sedov blast wave) against GPUCompress and runs it inside an Apptainer SIF
...
├── build.sh             # apptainer fakeroot build step (clones Nyx + AMReX, patches, links GPUCompress)
